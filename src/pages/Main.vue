  ...
  <div class="main">
    ...
    <div class="main__schedule">
      ...
      <div class="schedule-info">
        <p>
          ВЫПУЩЕН СБОРНИК ТЕЗИСОВ КРУГЛОГО СТОЛА «ЦЕРКОВНОЕ ПЕНИЕ: ТРАДИЦИИ И СОВРЕМЕННОСТЬ»
Получить бесплатный экземпляр можно по адресу: г. Санкт-Петербург, пр. Маршала Жукова, д. 60, корп. 1, лит. Б (храм во имя иконы Божией Матери «Державная»)
        </p>
        <br/>
